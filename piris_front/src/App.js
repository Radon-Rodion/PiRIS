...
function App() {
  ...
  const pathes = [
    ...
    {path: '/transactions', name: 'Статистика счетов', element: < TransactionsPage showBank={false}/>, authorizationLevel: 1},
    ...
    {path: '/transactions/bank', name: 'Статистика счетов банка', element: < TransactionsPage showBank={true}/>, authorizationLevel: 2},
